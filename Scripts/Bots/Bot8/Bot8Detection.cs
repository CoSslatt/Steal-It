...
namespace Res.Scripts.Bots.Bot8
{
	public class Bot8Detection : MonoBehaviour
	{
		...
		void Update()
		{
			if (Physics.CheckSphere(transform.position + new Vector3(0, 2f), 5f, player)||
				...
				Physics.CheckSphere(transform.position + new Vector3(-8f, 2f, 6.5f), 5f, player))
			{
		...
		private void OnDrawGizmosSelected()
		{
			...
			Gizmos.DrawWireSphere(transform.position + new Vector3(-8f, 2f, 6.5f), 5f);
		}
	}
}